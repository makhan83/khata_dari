...
class DataTableDemo extends StatefulWidget {
  //
  DataTableDemo() : super();
  static const String id = 'datatable_page';
...
class DataTableDemoState extends State<DataTableDemo> {
  ...
  _showValues(Employee employee) {
    _firstNameController.text = employee.fullname;
    _lastNameController.text = employee.village_town;
  }
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          rows: _employees
              ...
              DataCell(
                Text(
                  employee.village_town.toUpperCase(),
                ),
                onTap: () {
                  _showValues(employee);
                  // Set the Selected employee to Update

...
class NumberToWords {
  ...
  static String convert(int number, String locale) {
    ...
    String snumber = number.toString().padLeft(10, "0");
    // XXXnnnnnnnnn
    int billions = int.parse(snumber.substring(0, 3));
    // nnnXXXnnnnnn
    int millions = int.parse(snumber.substring(3, 5));
    // nnnnnnXXXnnn
    int hundredThousands = int.parse(snumber.substring(5, 7));
    // nnnnnnnnnXXX
    int thousands = int.parse(snumber.substring(7, 10));

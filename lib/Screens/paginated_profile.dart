...
class ViewProfile1 extends StatefulWidget {
  ViewProfile1() : super();
  static const String id = 'viewprofile1_page';

  final String title = 'Muneer Mango Centre';


  @override
  ViewProfile1State createState() => ViewProfile1State();
}

class ViewProfile1State extends State<ViewProfile1> {
  ...
  _updateFarmer() {
    ...
    // print('In update function: $_farmerId');
    // print('in update function : $_fullName');
    // print('in update function : $_fatherName');
    // print('in update function : $_cityName');
    // print('in update function : $_pinCode');
    // print('in update function : $_districtName');
    // print('in update function : $_stateName');
    // print('in update function : $_mobileNbr');
    // print('in update function : $_phoneNbr');
    // print('in update function : $_emailName');
    // print('in update function : $_idName');
    // print('in update function : $_idNbr');
    // print('in update function : $_bankName');
    // print('in update function : $_acctType');
    // print('in update function : $_acctNbr');
    // print('in update function : $_ifscCode');
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                if (_formKey1.currentState!.validate() || _formKey2.currentState!.validate())
                                {
                                  ...
                                  //_farmerId = _selectedFarmer!.farmer_id;
                                  //_fullName = _fullNameController!.text;
                                  //print('Farmer ID: ${_selectedFarmer!.farmer_id}');
